...
/*
Crea una función flecha que calcule el precio de la entrada a un evento universitario. La función debe recibir
obligatoriamente el precio base y el tipo de boleto ("GENERAL" o "VIP"). Además, debe recibir un código de
descuento de estudiante que es opcional.
...
*/
// Definición de tipos válidos para el boleto
type TipoBoleto = "GENERAL" | "VIP";

// Función flecha con parámetros obligatorios y uno opcional
const calcularPrecio = (precioBase: number, tipo: TipoBoleto, codigo?: string): number => {
